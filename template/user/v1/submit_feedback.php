...
<head>
    ...
    <style>
        ...
        .header {background-color: #673AB7;color: white;padding: 25px 30px;font-size: 18px;border-bottom: 4px solid #5E35B1;}
        .content {padding: 30px;}
        .info-card {background: #f9f9f9;border-radius: 6px;padding: 20px;margin-bottom: 25px;border-left: 4px solid #7E57C2;}
        ...
        .btn {display: inline-block;background: #673AB7;color: white !important;text-decoration: none;padding: 10px 20px;border-radius: 4px;margin: 20px 0;font-weight: bold;}
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="info-card">
                ...
                ' . ($type === 'api' ? '<div><span class="info-label">关联接口</span><span class="info-value">ID：' . $api_id . '</span></div>' : '') . '
            </div>
            <div>
